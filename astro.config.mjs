...
export default defineConfig({
  site: config.site.base_url ? config.site.base_url + config.site.base_path : "https://nagarizki.github.io/site",
  base: config.site.base_path ? config.site.base_path : "/site",
